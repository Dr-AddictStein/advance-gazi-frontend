...
export default function Signup() {
  ...
  return (
    ...
    <label htmlFor="passport" className="text-[#254B2D] pl-2 pb-2 text-left font-extrabold text-md">IC/Passport Number</label> 
        <input
          id="passport"
          name="passport"
          type="text"
       ...
       <div className=""> {formik.errors.passport && formik.touched.passport ? (
          <div className="text-[#FE814B] text-center bg-[#FFD2C2] w-[350px] py-2 rounded-3xl font-semibold text-md">{formik.errors.passport}</div>
        ) : null}</div>
        </div>
        <div type="submit" className=" w-[420px] mb-16 mt-10 flex justify-center rounded-b-[40px]">
      ...
      <div className="pb pt-24 pb-5">

<span className="fon font-medium text-[#1F160FA3]">Already have an account? </span><span className=" text-[#FE814B] font-medium underline">Sign In.</span>
